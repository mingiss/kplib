...
// #define KP_MSG_ERROR_HELP_PL_1250      ((const unsigned char *)".  Po pomoc technicznπ zwrÛÊ siÍ pod adres %s. Do listu za≥πcz plik %s")
#define KP_MSG_ERROR_HELP_PL_1250         ((const unsigned char *)".  Po pomoc technicznπ zwrÛÊ siÍ pod adres %s")
