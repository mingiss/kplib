...
//#define KP_MSG_ERROR_HELP_RU      ((const unsigned char *)".  За технической помощью обращайтесь по адресу %s   Для более подробной информации см. файл %s")
//#define KP_MSG_ERROR_HELP_RU      ((const unsigned char *)".  За технической помощью обращайтесь по электронной почте, адрес %s   К сообщению присоедините файл %s")
#define KP_MSG_ERROR_HELP_RU        ((const unsigned char *)".  За технической помощью обращайтесь по электронной почте, адрес %s")
...
#define KP_MSG_DIAG_MSG_EXPL_RU           ((const unsigned char *)"Для того, чтобы послать диагностическое сообщение производителю, необходимо " \
                                                                  ...
                                                                  "указанному адресу, обращайтесь за консультацией по адресу %s")
#endif
