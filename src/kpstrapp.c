...
/* ----------------------- */
void kp_append_str(const KpStrPtr out_str, KpStrPtr *str_buf_ptr, int *buf_len_ptr)
{
...
void kp_append_str_and_free(KpStrPtr out_str, KpStrPtr *str_buf_ptr, int *buf_len_ptr)
{
    if (out_str)
    {
...
void kp_append_chr(const uchar out_chr, KpStrPtr *str_buf_ptr, int *buf_len_ptr)
{
